# PROPOSAL KSIĄŻKI DLA WYDAWNICTWA AKADEMICKIEGO
...
W ostatniej dekadzie kilka sektorów CAPEX-intensywnych przeszło transformację finansowania, której standardowa teoria corporate finance nie jest w stanie wyjaśnić.

**Anomalia 1: Zagadka Blackstone.** W 2015 roku centrum danych w USA o wartości 500 milionów dolarów byłoby finansowane przez konsorcjum 3-4 banków: 70% długu uprzywilejowanego, 30% kapitału własnego developera. W 2024 roku podobne projekty finansuje Blackstone z funduszy infrastrukturalnych oraz Apollo z private credit, przy minimalnym udziale banków. Centra danych nie stały się mniej rentowne — wręcz przeciwnie. Banki nie stały się mniej płynne. A jednak struktura finansowania zmieniła się fundamentalnie.

**Anomalia 2: Zagadka PPA.** Farmy wiatrowe offshore na Morzu Północnym kosztują 3-5 miliardów euro i oferują IRR na poziomie 8-12%. Teoretycznie powinny łatwo przyciągać kapitał. Jednak żaden bank nie udzieli kredytu bez 15-letniego Power Purchase Agreement z wiarygodnym odbiorcą. Dlaczego 8-12% IRR nie wystarcza? Dlaczego finansowanie wymaga 15-letniego kontraktu?

**Anomalia 3: Zagadka TSMC.** TSMC ma 40 miliardów dolarów gotówki, generuje 30 miliardów dolarów rocznego operacyjnego cash flow i ma dostęp do każdego rynku kapitałowego na świecie. A jednak budowa fabryki za 40 miliardów dolarów w Arizonie wymagała 6,6 miliarda dolarów dotacji z CHIPS Act plus 5 miliardów dolarów preferencyjnych pożyczek. Dlaczego najbardziej rentowna firma w historii półprzewodników potrzebuje wsparcia państwa do sfinansowania inwestycji?

**Anomalia 4: Zagadka SpaceX.** SpaceX ma niekonwencjonalną strukturę kapitałową: długoterminowe kontrakty NASA i Departamentu Obrony, powtarzające się rundy private equity przy rosnących wycenach, minimalny dług bankowy. Ta struktura przeczy przewidywaniom teorii pecking order. Dlaczego działa?

Te cztery anomalie mają wspólny rdzeń. Tradycyjna teoria corporate finance — trade-off, pecking order, teoria agencji — została zaprojektowana dla świata marginalnych decyzji inwestycyjnych i zamiennego kapitału. W sektorach CAPEX-intensywnych, gdzie inwestycje są duże, nieodwracalne i długoterminowe, te ramy teoretyczne oferują ograniczone wskazówki.

---

### Argument: Od ryzyka rentowności do architektury finansowania
...
### Warunki brzegowe: Kiedy architektura zawodzi
...
- **Wyścigi inwestycyjne**: przeinwestowanie CAPEX → wojny cenowe → ROIC poniżej WACC

Ta krytyczna analiza pokazuje, że proponowany framework jest falsyfikowalny, nie jedynie opisowy.
...
## 5. POZYCJONOWANIE WOBEC LITERATURY

### Relacja do istniejącej literatury

Książka wchodzi w dialog z pięcioma głównymi nurtami literatury ekonomicznej i finansowej, jednocześnie od nich odchodząc:
...
**Luka adresowana przez tę książkę:** Te ramy zakładają, że projekty inwestycyjne firmy i ich przepływy pieniężne są dane; pytanie brzmi, jak je optymalnie sfinansować. W sektorach CAPEX-intensywnych przepływy pieniężne nie są dane, lecz *konstruowane* poprzez aranżacje kontraktowe.
...
**Luka adresowana przez tę książkę:** Project finance był traktowany jako wyspecjalizowana technika dla wąskiej klasy aktywów. Ta książka argumentuje, że logika project finance staje się szablonem dla corporate finance w sektorach CAPEX-intensywnych w ogóle.

#### 3. Kontrakty niekompletne i prawa własności

**Kluczowe prace:** Hart & Moore (1990, 1994); Williamson (1985, 1996); Grossman & Hart (1986)
...
**Kluczowe prace:** Dixit & Pindyck (1994); McDonald & Siegel (1986); Abel & Eberly (1994)

**Co ta literatura robi:** Analizuje decyzje inwestycyjne, gdy wyniki są niepewne, a inwestycje nieodwracalne.

**Luka adresowana przez tę książkę:** Ta literatura koncentruje się na decyzji o inwestycji, ale mówi niewiele o tym, jak sfinansować po podjęciu decyzji. Ta książka pokazuje, że struktury finansowania mogą redukować postrzeganą niepewność.
...
## 8. KONKURENCYJNE TYTUŁY

| Tytuł | Autor | Wydawnictwo | Rok | Jak ta książka się różni |
|-------|-------|-------------|-----|--------------------------|
| *Theory of Corporate Finance* | Jean Tirole | Princeton UP | 2006 | Tirole dostarcza ogólną teorię; ta książka adresuje specyfikę sektorów CAPEX-intensywnych |
| *Modern Project Finance* | Benjamin Esty | Wiley | 2004 | Esty traktuje PF jako niszę; ta książka pokazuje rozlewanie się logiki PF na corporate finance |
| *Project Finance in Theory and Practice* | Stefano Gatti | Academic Press | 2013 | Gatti jest zorientowany na praktykę; ta książka dostarcza ramy teoretyczne |
| *Investment under Uncertainty* | Dixit & Pindyck | Princeton UP | 1994 | D&P koncentrują się na decyzji inwestycyjnej; ta książka adresuje finansowanie po decyzji |
| *The Entrepreneurial State* | Mariana Mazzucato | Anthem Press | 2013 | Mazzucato koncentruje się na innowacjach; ta książka na finansowaniu CAPEX |

---

## 9. LIST PRZEWODNI DO REDAKTORA
...
Jestem gotów dostarczyć dodatkowe materiały, w tym rozdział próbny, na życzenie. Dziękuję za rozpatrzenie propozycji.
...
- [x] Krótki opis (150 słów)
- [x] Szczegółowy opis (2-3 strony)
- [x] Spis treści
- [x] Abstrakty rozdziałów
- [x] Pozycjonowanie wobec literatury
- [x] Specyfikacje techniczne
- [ ] O autorze — DO UZUPEŁNIENIA
- [x] Konkurencyjne tytuły
- [x] List przewodni
